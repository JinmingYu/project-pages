...
<ul class="post-list">
	...
	{% for post in site.posts %} 
		...
		<td valign="middle">
			<li>
				{% if post.author.image %}<img class="fancybox" title=post.auther.name data-big="big-image.jpg" src="{{ post.author.image }}" style="float: left; height: 125px; border-radius: 50%; border: 25px solid transparent">{% endif %}
